      ...
      child: Column(
        children: <Widget>[
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    SizedBox(width: 20,),
                    Text('Hello athithi',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,),),
                  ],
                ),
              ],
            ),
          ...
          SizedBox(
           ...
           FlatButton(
             shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
              ...
              child: Text('Booked Tickets',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,),),
          ...
          FlatButton(
            ...
            child: Text("Your Cart",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
          )
        ],
      ),
    );
